...
public class RoomServiceImpl implements RoomService {
    ...
    @Override
    public List<RoomModel> getAvailableRooms(LocalDate checkInDate, LocalDate checkOutDate, String roomType) {
        return roomRepository.findAllRoomsByDatesAndType(checkInDate, checkOutDate, roomType);
    }
}
